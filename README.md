...
- Open a __new browser tab__, and work on the steps in your second tab while you read the instructions in this tab.
...
> On the **Edit file** tab, add a `#`, followed by a **space**, <br /> before any content you like to make it an H1 Header. You can add more headers, using one to six `#` characters followed by a **space**.
...
# **Changes Made** : Added some # to sentences and made some words italic / bold
